    ...
    public void updateRatingPoint() {
        ...
        for (Country instance : countryList) {
            ...
            if (instance.playerList.size() > 0) {
                ...
                instance.ICCTestRating = instance.ICCTestAddRating;
            }
...
//                
    ...
    public void switchReadable() throws IOException {

        this.writer = new PrintWriter(new FileWriter("databaseReadable.txt"));
    ...
    public void read_file() {
        try {
            ...
            String temp;
           Scanner reader  = new Scanner(new File("databaseReadable.txt"));
                temp = "";
           ...
           if ("true".equals(temp)) {
                System.out.println("Read from "+file_input);
               ...
               while (reader.hasNextLine()) {
                    ...
                    if (add_country(new Country(text_country)) == true) {
                        readCountry_Scanner++;//Country read
                    }
                    for (int i = 0; i < text_numPlayer; i++) {
                        ...
                        //reader.nextLine();
                        if (add_player(text_country, new Player(text_rating, text_name, text_age, text_pos)) == true) {
                            readPlayer_Scanner++;//Player Read
                        }
                    }
